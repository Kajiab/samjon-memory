...
def test_add_memory_to_collection(service):
    ...
    mem = service.create_memory({"subject": "mem", "raw_content": "content", "source": "test"})
...
def test_reorder_collection(service):
    ...
    m1 = service.create_memory({"subject": "m1", "raw_content": "c1", "source": "test"})
    m2 = service.create_memory({"subject": "m2", "raw_content": "c2", "source": "test"})
